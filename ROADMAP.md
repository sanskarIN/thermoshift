...
- [x] Expand frontend unit/component tests for persistence, backup, update, logging, accessibility, and keyboard behavior.
...
- [ ] Add broader browser engines/device labs when the maintenance cost is justified by supported-user coverage.
